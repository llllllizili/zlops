<template>
  <div class="app-container">
    ...
    <el-card style="margin-top: 2px">
      <el-table :data="wfstateList" style="width: 100%">
        ...
        <el-table-column align="center" label="操作" width="220px">
          <template slot-scope="scope">
            <el-link
              v-if="checkPermission(['workflow_manage'])"
    ...
    >
      ...
      >
        ...
        <el-form-item label="参与者类型" prop="participant_type">
          <el-select
            style="width: 100%"
            v-model="wfstate.participant_type"
            placeholder="请选择"
            @change="typeChange"
          >
            <el-option
        ...
        <el-form-item
          label="参与者"
          prop="participant"
          v-if="wfstate.participant_type == 1"
        >
          <el-select
            style="width: 100%"
            v-model="participant"
        ...
        <el-form-item
          label="参与者"
          prop="participant"
          v-if="wfstate.participant_type == 2"
        >
          <el-select
            style="width: 100%"
        ...
        <el-form-item
          label="参与者"
          prop="participant"
          v-if="wfstate.participant_type == 7"
        >
          <el-select
            style="width: 100%"
            v-model="participant"
        ...
        >
          <el-select
            style="width: 100%"
            v-model="wfstate.distribute_type"
            placeholder="请选择分配方式"
          >
        ...
        <el-form-item
          label="角色"
          prop="participant"
          v-if="wfstate.participant_type == 4"
        >
          <el-select
            style="width: 100%"
            v-model="participants"
        ...
        <el-form-item
          label="代码选择"
          prop="participant"
          v-if="wfstate.participant_type == 9"
        >
          <el-select
            style="width: 100%"
            v-model="participants"
        ...
        <el-form-item label="抄送给" prop="participant">
          <el-select
            style="width: 100%"
            v-model="wfstate.participant_cc"
            multiple
            placeholder="请选择抄送给谁"
          >
            <el-option
        ...
        <el-form-item label="字段状态">
          ...
          <el-row
            v-for="(item, $index) in statusChange"
            :key="item + $index"
        ...
        if (valid) {
          ...
          if (this.statusChange.length > 0) {
            for (let i = 0; i < this.statusChange.length; i++) {
              state_fields[this.statusChange[i].name] =
          ...
          this.wfstate.participant =
            this.wfstate.participant_type === 1
              ? this.participant
              : this.participants;
          if (isEdit) {
