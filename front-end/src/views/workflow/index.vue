    ...
    <el-card>
      <div>
        ...
        <el-button
          ...
          >重置</el-button
        >
        <el-button v-if="checkPermission(['workflow_create'])" type="primary" icon="el-icon-plus" @click="handleCreate"
          >新增</el-button
        >
      </div>
    </el-card>
        ...
        <el-table-column align="center" label="操作" width="300px">
          <template slot-scope="scope">
            ...
            <el-link
              ...
              >删除</el-link
            >
            <el-link type="primary" @click="handleTicket(scope)"
              >查看工单</el-link
            >
            <el-link type="primary" @click="handleWatch(scope)"
              >查看流程图</el-link
            >
          </template>
        </el-table-column>
    ...
    >
      ...
      >
        ...
        <el-form-item label="标题模板" prop="title_template">
          <el-input
            v-model="workflow.title_template"
            placeholder="你有一个待办工单:{title}"
          />
        </el-form-item>
        <el-form-item label="内容模板" prop="content_template">
          <el-input
            v-model="workflow.content_template"
            placeholder="标题:{title}, 创建时间:{create_time}"
          />
        </el-form-item>
      </el-form>
