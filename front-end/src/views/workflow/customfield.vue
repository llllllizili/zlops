      ...
      >
        ...
        <el-form-item
          ...
          v-show="
            ...
            customfield.field_type == 'selects'
          "
        >
        ...
        >
          ...
          <el-row
            v-for="(domain, $index) in choiceOption"
            :key="$index + 1"
            ...
            <el-col :span="10">
              <template>
                <el-form-item label="name：">
                  <el-input
                    v-model="choiceOption[$index].name"
                    auto-complete="off"
                  ></el-input>
                </el-form-item>
              </template>
        ...
        <el-form-item label="模板">
          <el-input
            v-model="customfield.field_template"
    ...
    async confirm(form) {
      ...
      this.$refs[form].validate((valid) => {
        if (valid) {
          ...
          if (
            that.choiceOption[0] &&
            that.choiceOption[0].name !== "" &&
            that.choiceOption[0].name !== null &&
            that.choiceOption[0].name !== undefined
          ) {
          ...
          if (isEdit) {
            updateWfCustomfield(this.customfield.id, this.customfield).then(
              (res) => {
                if (res.code >= 200) {
                  this.getList();
