# Generated by Django 4.2.11 on 2024-06-03 07:50
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.CharField(blank=True, default='/media/avatar.png', max_length=100, null=True, verbose_name='头像')),
            ],
            options={
                'verbose_name': '用户信息',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(blank=True, max_length=50, null=True, verbose_name='描述')),
                ('depts', models.ManyToManyField(blank=True, related_name='roles', to='system.organization', verbose_name='权限范围')),
