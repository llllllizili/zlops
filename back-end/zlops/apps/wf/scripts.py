...
class GetParticipants:
    ...
    all_funcs = [{"func": "get_create_by", "name": "获取工单创建人"}]
...
class HandleScripts:
    ...
    all_funcs = [{"func": "handle_something", "name": "处理一些工作"}]
    ...
    def to_next(
        ...
        # ticket.participant_type = State.PARTICIPANT_TYPE_ROBOT
        # ticket.participant= 1 # admin
